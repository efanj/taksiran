      ...
      accPutIcon = function () {
        acc.each(function (index) {
          ...
          accExp
            ...
            .append('<i class="' + plugin.settings.accordion.toggleIcon + '"></i>')
          accNor = $(this).find(".panel-collapse").not(".panel-collapse.in")
          accNor
            .prev(".panel-heading")
            .find("a.accordion-toggle")
            .append('<i class="' + plugin.settings.accordion.collapseIcon + '"></i>')
        })
      }
      ...
      ;(function (e) {
        e.fn.waitMe = function (g) {
          return this.each(function () {
                ...
                init: function () {
                  ...
                  switch (a.effect) {
                    ...
                    case "facebook":
                      ...
                      break
                    case "rotation":
                      ;(b = 1), (n = "border-color"), (d = ""), (c = "width:" + a.sizeW + ";height:" + a.sizeH)
                  }
                  "" == a.sizeW && "" == a.sizeH && (d = c = "")
                  if (0 < b) {
                    l = e('<div class="waitMe_progress ' + a.effect + '"></div>')
                    for (var k = 1; k <= b; ++k) h = m ? h + ('<div class="waitMe_progress_elem' + k + '" style="' + c + '"><div style="' + n + ":" + a.color + '"></div></div>') : h + ('<div class="waitMe_progress_elem' + k + '" style="' + n + ":" + a.color + ";" + c + '"></div>')
                    l = e('<div class="waitMe_progress ' + a.effect + '" style="' + d + '">' + h + "</div>")
                  }
                  a.text && (r = e('<div class="waitMe_text" style="color:' + a.color + '">' + a.text + "</div>"))
            ...
            if (q[g]) return q[g].apply(this, Array.prototype.slice.call(arguments, 1))
            if ("object" === typeof g || !g) return q.init.apply(this, arguments)
            e.event.special.destroyed = {
              remove: function (a) {
                a.handler && a.handler()
              }
      ...
      ;(function (c) {
        var f = -1,
          ...
          q = function (a) {
            ...
            c(a).each(function () {
              var a = c(this),
                l = a.offset().top - k(a.css("margin-top")),
                m = 0 < d.length ? d[d.length - 1] : null
        ...
        b._apply = function (a, e) {
          var d = n(e),
            ...
            g = c("html").outerHeight(!0),
            f = h.parents().filter(":hidden")
          f.css("display", "block")
          d.byRow &&
            (h.each(function () {
              var a = c(this),
