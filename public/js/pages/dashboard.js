...
$(document).ready(function () {
  ...
  var visitwmsLayer = L.tileLayer.betterWms("https://perancang.mps.gov.my/geoserver/mdpt/wms?", {
    layers: "mdpt:v_semak",
    format: "image/png",
    transparent: true,
    maxZoom: 25,
  ...
  var sempadanwmsLayer = L.tileLayer.wms("https://perancang.mps.gov.my/geoserver/mdpt/wms?", {
    layers: "mdpt:daerah",
    format: "image/png",
    transparent: true,
    maxZoom: 25,
