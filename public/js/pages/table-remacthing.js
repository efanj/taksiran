$(document).ready(function () {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function (data, type, row, meta) {
          console.log(data)
          if (type === "display") {
            data = '<a href="remacthaccount/' + row.id + '" class="btn btn-primary btn-sm mr5 mb10">Kemaskini</a>'
          }
          return data
        },
      },
  ...
  $("#remacthing tbody").css("font-size", 13)
})
