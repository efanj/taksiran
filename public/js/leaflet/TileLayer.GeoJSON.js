...
L.TileLayer.GeoJSON = L.TileLayer.Ajax.extend({
  ...
  _recurseLayerUntilPath: function (func, layer) {
    if (layer instanceof L.Path) {
      ...
      layer
        .getLayers()
        .forEach(this._recurseLayerUntilPath.bind(this, func), this)
    }
  },
  ...
  _clipLayerToTileBoundary: function (layer, tilePoint) {
    ...
    if (clipPath === null) {
      ...
      this._clipPathRectangles[clipPathId] = new L.Rectangle(
        new L.LatLngBounds([nw, se]),
        {
          opacity: 0,
          fillOpacity: 0,
          clickable: false,
    ...
    this._recurseLayerUntilPath(function (pathLayer) {
      pathLayer._container.setAttribute(
        "clip-path",
        "url(" + window.location.href + "#" + clipPathId + ")"
      )
    }, layer)
  },
