          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="row align-items-center">
                <div class="col">
                  <h4 class="ml15">MESEJ MESYUARAT JAWATAN KUASA PENILAIAN(MJP)</h4>
                </div>
                <!--end col-->
                <div class="col-auto">
            ...
            <div class="panel-body">
              <table id="message" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0;">
                <thead>
                  <tr>
                    <th>Kod</th>
                    <th>Keterangan</th>
