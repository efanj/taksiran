          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <div class="row align-items-center">
                <div class="col">
                  <h4 class="ml15">JENIS PEMILIK</h4>
                </div>
                <!--end col-->
                <div class="col-auto">
            ...
            <div class="panel-body">
              <table id="ownertype" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0;">
                <thead>
                  <tr>
                    <th>Kod Pemilik</th>
                    <th>Keterangan</th>
                    <th>Transaksi</th>
                    <th>Sumbangan Membantu Kadar</th>
                  </tr>
                </thead>
              </table>
            </div>
