        ...
        <div class="col-lg-8 col-sm-8 col-md-8 col-lg-offset-2 col-sm-offset-2 col-md-offset-2">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <hr class="mdpt">
              <div id="calc-oilstation" class="bwizard">
                <!-- Start .bwizard -->
                ...
                <form class="form-horizontal" role="form" id="calcOilStation" method="post">
                  ...
                  <div class="tab-content">
                    <div class=" tab-pane active" id="tab1">
                      ...
                      <table class="table table-bordered one" id="table_land" style="font-size:13px;">
                        <thead>
                          <tr>
                        ...
                        <tbody id="land_table">
                          <tr id="0">
                            <td><input type="text" class="form-control input-sm" name="land_title"></td>
                            <td><input type="number" class="form-control input-sm" name="land_breadth" id="land_breadth"
                                value="0"></td>
                            <td>
                              <select class="form-control input-sm" name="land_breadthtype">
                            ...
                            <td><input type="number" class="form-control input-sm" name="land_price" id="land_price"
                                value="0"></td>
                            <td>
                              <select class="form-control input-sm" name="land_pricetype">
                                <option selected>Sila Pilih</option>
                            ...
                            <td><input type="number" class="form-control input-sm ttl_partly" name="land_total"
                                id="land_total" readonly></td>
                            <td></td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <div class="tab-pane" id="tab2">
                      ...
                      <div class="form-group">
                        <label class="col-lg-2 col-md-3 control-label tal"><strong>Perkara</strong></label>
                        <div class="col-lg-10 col-md-9">
                          <input type="text" class="form-control input-sm" name="building_title">
                        </div>
                      </div>
                    ...
                    <div class="tab-pane" id="tab3">
                      ...
                      <table style="width:100%;font-size:13px;" class="calculator mb15">
                        <tr>
                          <td colspan="2" style="width:63%"><strong>NILAIAN</strong></td>
                          <td style="width:20%">
                        ...
                        <tr>
                          <td colspan="2"><strong>ABT 8% DARIPADA NILAIAN</strong></td>
                          <td>
