    ...
    <div class="page-content-inner">
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-md-8">
          <?php $hacmjb = $this->controller->account->viewamendPSdetail($siriNo); ?>
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4>NILAIAN SEMULA PEGANGAN - JADUAL B (PS)</h4>
            </div>
            <div class="panel-body">
              <div id="jadualps" class="bwizard">
                <!-- Start .bwizard -->
                ...
                <form class="form-horizontal" role="form" id="jadualPS" method="post" style="font-size:14px;">
                    ...
                    <div class="tab-pane" id="tab2">
                      ...
                      <div class="row mb5">
                        ...
                        <div class="col-md-2 control-label tal">
                          <span id="mjb_lsbgntb"><?= $hacmjb["smk_lsbgn_tmbh"] ?></span> m&sup2;
                        </div>
                        <div class="col-md-2">
                      ...
                      <div class="row mb10">
                        ...
                        <div class="col-md-2 control-label tal">
                          <span id="mjb_lsanstb"><?= $hacmjb["smk_lsans_tmbh"] ?></span> m&sup2;
                        </div>
                      </div>
                      <div class="row mb5">
                        <div class="col-md-2">
