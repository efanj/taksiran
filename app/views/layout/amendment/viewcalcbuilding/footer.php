...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard/wizard-viewbuilding.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/print/print-building.js" type="text/javascript"></script>
