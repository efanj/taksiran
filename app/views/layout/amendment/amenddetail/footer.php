...
<script src="<?= PUBLIC_ROOT ?>js/pages/amend-detail.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/mapview_amenddetail.js" type="text/javascript"></script>
