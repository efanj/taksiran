...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard/wizard-land.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc/calc-land.js" type="text/javascript"></script>
