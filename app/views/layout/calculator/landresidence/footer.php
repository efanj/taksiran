...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard-landresidence.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc-landresidence.js" type="text/javascript"></script>
