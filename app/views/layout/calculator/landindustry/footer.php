...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard-landindustry.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc-landindustry.js" type="text/javascript"></script>
