...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard-oilstation.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc-oilstation.js" type="text/javascript"></script>
