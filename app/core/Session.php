...
class Session{
    ...
    public static function getUserGroup(){
        return empty($_SESSION["group"]) ? null : $_SESSION["group"];
    }
     ...
     *
     */
    public static function getUserWorkerId(){
        return empty($_SESSION["workerid"]) ? null : $_SESSION["workerid"];
    }
