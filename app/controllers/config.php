...
return array(
    ...
    "COPYRIGHT" => "Hakcipta Terpelihara Majlis Daerah Perak Tengah &copy; ",
  ...
  //   (ADDRESS_LIST =
  //     (ADDRESS = (PROTOCOL = TCP)(HOST = 10.82.20.85)(PORT = 1521))
  //   )
  //   (CONNECT_DATA =
  //     (SID = mdkpr)
  //   )
  // )",
  //   "ORACLE_DB" => "oci:dbname=10.82.20.85:1521/mdkpr",

    "ORACLE_DB_USER" => "SPMC",
    "ORACLE_DB_PASS" => "SPMC",
    "ORACLE_TNS" => "(DESCRIPTION =
    (ADDRESS_LIST =
      (ADDRESS = (PROTOCOL = TCP)(HOST = 60.53.186.113)(PORT = 6942))
    )
    (CONNECT_DATA =
      (SID = mdkpr)
    )
  )",
    "ORACLE_DB" => "oci:dbname=60.53.186.113:6942/mdkpr",
